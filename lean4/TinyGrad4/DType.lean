...
inductive DType where
  ...
  | fp8e4m3   -- Float8 with 4-bit exponent, 3-bit mantissa
  | fp8e5m2   -- Float8 with 5-bit exponent, 2-bit mantissa
...
def isFloat : DType → Bool
  | .fp8e4m3 | .fp8e5m2 | .float16 | .bfloat16 | .float32 | .float64 => true
